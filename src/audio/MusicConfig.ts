...
const LEVEL_1_MUSIC: MusicConfig = {
  ...
  beatsPerMeasure: 4,
  root: 57,
  scale: buildScale(57, MINOR_PENTA),
  kick: {
    steps: [
      true,
      false,
...
const LEVEL_4_MUSIC: MusicConfig = {
  ...
  beatsPerMeasure: 4,
  root: 55,
  scale: buildScale(55, MIXOLYDIAN),
  kick: {
    steps: [
      true,
      false,
...
const LEVEL_6_MUSIC: MusicConfig = {
  ...
  beatsPerMeasure: 4,
  root: 52,
  scale: buildScale(52, NATURAL_MINOR),
  kick: {
    steps: [
      true,
      false,
...
const LEVEL_7_MUSIC: MusicConfig = {
  ...
  beatsPerMeasure: 4,
  root: 49,
  scale: buildScale(49, HARMONIC_MINOR),
  kick: {
    steps: [
      true,
      false,
...
const LEVEL_8_MUSIC: MusicConfig = {
  ...
  beatsPerMeasure: 4,
  root: 57,
  scale: buildScale(57, MAJOR_PENTA),
  kick: {
    steps: [
      true,
      false,
...
const LEVEL_9_MUSIC: MusicConfig = {
  ...
  beatsPerMeasure: 4,
  root: 58,
  scale: buildScale(58, WHOLE_TONE),
  kick: {
    steps: [
      true,
      false,
